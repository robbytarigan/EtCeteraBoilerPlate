<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="PubsClient.WebForm1" %>
...
<body>
    ...
    <div>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Services>
                <asp:ServiceReference Path="http://localhost:49169/Authors.asmx" />                
            </Services>
        </asp:ScriptManager>
    </div>
